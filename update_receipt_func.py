...
# Update the payment_receipt function to work with payment ID
new_receipt_func = '''
...
content = re.sub(pattern, new_receipt_func, content, flags=re.DOTALL)

with open('admin_panel/views.py', 'w', encoding='utf-8') as f:
    f.write(content)
print('✓ Updated payment_receipt function to work directly from payment')
