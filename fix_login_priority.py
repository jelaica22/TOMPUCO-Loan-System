...
def user_login(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            # FIRST: Check StaffProfile for role (Manager redirects to Manager Portal)
            try:
            ...
            # SECOND: Super Admin (if not a manager)
...
with open('main/views.py', 'w', encoding='utf-8') as f:
    f.write(content)
print('✓ Updated login - Manager role checked BEFORE Super Admin')
